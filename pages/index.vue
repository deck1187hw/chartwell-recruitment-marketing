          ...
          <div class="row text-right">
            <div class="col-lg-12">
              <ul class="menu-horizontal text-center linklang">
                <li>
                  <a href="#" @click="changeLang('en-gb')" :class="{'active': $store.state.language == 'en-gb'}">English</a>
                </li>
                <li>
                  <a href="#" @click="changeLang('de-de')" :class="{'active': $store.state.language == 'de-de'}">Deutsch</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="row justify-content-between align-items-center">
            <div class="col-lg-5 col-md-7">
              <div class="switchable__text">
                ...
                <a class="btn btn--primary type--uppercase" :href="document.link_start_application.url">
                  <span class="btn__text">{{document.start_application_text}}</span>
                </a>
              </div>
            </div>
...
<br />
              <a class="btn type--uppercase" :href="document.case_study_pdf_link.url" target="_blank">View case study</a>
              </div>
            </div>
            <div class="col-md-12">
        ...
        <div class="container">
          ...
          <br />
                <div class="video-cover border--round">
                  ...
                  <div class="video-play-icon"></div>
                  <iframe :data-src="document.section_5_video.url" allowfullscreen="allowfullscreen"></iframe>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-8 col-lg-6">
              <div class="cta">
                ...
                <a class="btn btn--primary type--uppercase" :href="document.link_start_application.url" target="_self">
